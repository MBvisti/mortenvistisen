...
;"object"==typeof exports&&"undefined"!=typeof module&&(module.exports=hljs);/*! `makefile` grammar compiled for Highlight.js 11.5.1 */
...
})();hljs.registerLanguage("xml",e)})();/*! `go` grammar compiled for Highlight.js 11.5.1 */
...
;hljs.registerLanguage("python",e)})();/*! `sql` grammar compiled for Highlight.js 11.5.1 */
(()=>{var e=(()=>{"use strict";return e=>{
...
begin:/[-+*/=%^~]|&&?|\|\|?|!=?|<(?:=>?|<|>)?|>[>=]?/,relevance:0}]}}})()
;hljs.registerLanguage("sql",e)})();/*! `lua` grammar compiled for Highlight.js 11.5.1 */
...
subLanguage:"bash"}}]})})();hljs.registerLanguage("shell",s)})();/*! `markdown` grammar compiled for Highlight.js 11.5.1 */
...
aliases:["yml"],contains:b}}})();hljs.registerLanguage("yaml",e)})();/*! `typescript` grammar compiled for Highlight.js 11.5.1 */
(()=>{var e=(()=>{"use strict"
