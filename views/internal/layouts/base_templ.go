...
func footer() templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		ctx = templ.ClearChildren(ctx)
		_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString("<footer class=\"bg-base-300 w-full\"><div class=\"py-12 p-10 bg-base-100 max-w-screen-xl mx-auto grid grid-cols-4 md:grid-cols-6 lg:grid-cols-12\"><div class=\"col-span-full md:col-start-2 md:col-end-6 lg:col-start-3 lg:col-end-11 mt-10 flex flex-col items-center justify-between gap-6\"><div class=\"flex flex-wrap justify-center gap-x-6 gap-y-1 text-sm font-medium text-zinc-200\"><a class=\"transition hover:text-teal-400\" href=\"/\">Home</a> <a class=\"transition hover:text-teal-400\" href=\"/articles\">Articles</a> <a class=\"transition hover:text-teal-400\" href=\"/about\">About</a></div><p class=\"text-sm text-zinc-500\">")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `views/internal/layouts/base.templ`, Line: 69, Col: 46}
		}
