...
func Articles(data []ArticleViewData, paginationProps components.PaginationProps, tkn string) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Var2 := templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
			...
			ctx = templ.InitializeContext(ctx)
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 1, "<div class=\"container mx-auto grid grid-cols-12 gap-4\"><div class=\"col-start-2 col-span-10\"><h2 class=\"text-xl\">Articles</h2></div><div class=\"col-start-11 col-end-12\"><a role=\"button\" href=\"/dashboard/articles/create\" class=\"btn btn-success w-full text-white\">New</a></div><div class=\"flex flex-col col-span-10 col-start-2\"><div class=\"w-full overflow-x-auto flex flex-col\"><table class=\"bg-base-200 w-full table mb-4\"><!-- head --><thead><tr><th></th><th class=\"text-lg\">Title</th><th class=\"text-lg\">Slug</th><th class=\"text-lg\">Status</th><th class=\"text-lg\">Released On</th></tr></thead> <tbody>")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			for _, article := range data {
				templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 2, "<tr class=\"hover\"><th><div><a href=\"")
				if templ_7745c5c3_Err != nil {
					return templ_7745c5c3_Err
				}
				...
				templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 3, "\"><button class=\"btn btn-primary btn-sm\">Edit</button></a></div></th><td>")
				if templ_7745c5c3_Err != nil {
					return templ_7745c5c3_Err
				}
				...
				if !article.Draft {
					templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 6, "<span class=\"text-success\">Released</span>")
					if templ_7745c5c3_Err != nil {
						return templ_7745c5c3_Err
					}
				} else {
					templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 7, "<span class=\"text-danger\">In draft</span>")
					if templ_7745c5c3_Err != nil {
						return templ_7745c5c3_Err
					}
				}
				...
				if article.Draft {
					templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 9, "<td>Not relased yet</td>")
					if templ_7745c5c3_Err != nil {
						return templ_7745c5c3_Err
					}
				} else {
