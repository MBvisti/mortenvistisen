...
func CreateNewsletter(ctx context.Context, exec storage.Executor, opts ...NewsletterOption) (models.Newsletter, error) {
...
func CreateNewsletters(ctx context.Context, exec storage.Executor, count int, opts ...NewsletterOption) ([]models.Newsletter, error) {
