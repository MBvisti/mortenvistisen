...
func CreateSubscriber(ctx context.Context, exec storage.Executor, opts ...SubscriberOption) (models.Subscriber, error) {
...
func CreateSubscribers(ctx context.Context, exec storage.Executor, count int, opts ...SubscriberOption) ([]models.Subscriber, error) {
