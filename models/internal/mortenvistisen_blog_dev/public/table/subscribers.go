...
type subscribersTable struct {
	...
	SubscribedAt postgres.ColumnTimestampz
	Referer      postgres.ColumnString
...
func newSubscribersTableImpl(schemaName, tableName, alias string) subscribersTable {
	var (
		...
		SubscribedAtColumn = postgres.TimestampzColumn("subscribed_at")
		RefererColumn      = postgres.StringColumn("referer")
		IsVerifiedColumn   = postgres.BoolColumn("is_verified")
		allColumns         = postgres.ColumnList{IDColumn, CreatedAtColumn, UpdatedAtColumn, EmailColumn, SubscribedAtColumn, RefererColumn, IsVerifiedColumn}
		mutableColumns     = postgres.ColumnList{CreatedAtColumn, UpdatedAtColumn, EmailColumn, SubscribedAtColumn, RefererColumn, IsVerifiedColumn}
	)
	...
	return subscribersTable{
		...
		Email:        EmailColumn,
		SubscribedAt: SubscribedAtColumn,
		Referer:      RefererColumn,
