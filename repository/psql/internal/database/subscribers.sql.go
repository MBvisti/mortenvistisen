...
select subscribers.id, subscribers.created_at, subscribers.updated_at, subscribers.email, subscribers.subscribed_at, subscribers.referer, subscribers.is_verified
from subscribers
limit $1
offset $2
`
