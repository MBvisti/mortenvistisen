...
<div class="form-control min-w-fit">
    ...
    <form hx-post="/subscribe" hx-target="this" hx-swap="outerHTML" method="POST" action="/subscribe" class="mt-2 relative min-w-[20rem]"
        ...
        <input type="hidden" name="referer" value="how-to-do-integration-test-with-go" />
        ...
        <button data-loading-disable type="submit"
            class="btn btn-primary absolute top-0 right-0 rounded-l-none umami--click--newsletter-how-to-do-integration-test-with-go">
            Get Notified
        </button>
