...
func (d Dashboard) NewslettersIndex(ctx echo.Context) error {
	...
	totalNewslettersCount, err := d.newsletterSvc.Count(
		ctx.Request().Context(),
		false,
	)
	if err != nil {
	...
	pagination := components.PaginationProps{
		...
		TotalPages: d.base.CalculateNumberOfPages(
			int(totalNewslettersCount),
			7,
		),
	}
...
// 	}
//
// 	newsletter, err := d.newsletterSvc.ByID(
// 		ctx.Request().Context(),
// 		newsletterID,
// 	)
// 	if err != nil {
...
// 	}
//
// 	releasedNewslettersCount, err := d.newsletterSvc.Count(
// 		ctx.Request().Context(),
// 		true,
// 	)
// 	if err != nil {
