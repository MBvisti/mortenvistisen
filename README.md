...
2. **Create database**
   ```bash
   createdb mortenvistisen_development
   ```
...
```go
import "mortenvistisen/queue/jobs"
...
MAILPIT_PORT=1025
DEFAULT_SENDER_SIGNATURE=info@mortenvistisen.com
...
# Cloudflare R2 article covers
R2_ACCOUNT_ID=1e47e69178115fb8a1b60e498ac7f0a1
R2_BUCKET=mbv-blog
R2_PUBLIC_BASE_URL=https://media.mortenvistisen.com
R2_COVER_PREFIX=covers
R2_ACCESS_KEY_ID=
R2_SECRET_ACCESS_KEY=
R2_MAX_UPLOAD_BYTES=10485760

# Telemetry (optional)
TELEMETRY_SERVICE_NAME=mortenvistisen
